...
function Modal({ onClose }) {
  const handleCall = () => {
    window.location.href = "tel:+201222209569";
  };
    ...
    <section className="modal-overlay">
      <div className="modal">
        ...
        <div className="modal__icons">
          <button onClick={handleCall} className="modal__icon-button">
            <svg
          ...
          <button onClick={handleTelegram} className="modal__icon-button">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
          ...
          <button onClick={handleWhatsApp} className="modal__icon-button">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
